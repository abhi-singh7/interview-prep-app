...
Define the DTO structures used for native structured output serialization/deserialization between Spring AI and LM Studio, including question generation and evaluation response types.
