...
Define how the system communicates with the OpenAI-compatible LLM backend (LM Studio) using Spring AI's ChatClient API, including structured output handling and configuration.
