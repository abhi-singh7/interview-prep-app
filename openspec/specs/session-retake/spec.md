...
Provide a read-only detail view for completed interview sessions showing all questions, answers, and evaluations, along with retake functionality that starts fresh interviews using the same topic selection.
